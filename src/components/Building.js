    ...
    if (props.type == "cps") {
        return (
            <div className="flex justify-between min-h-[25%] w-full border-[#FFFDE7] border-[1px] overflow-y-auto rounded-md">
                ...
                <div className="flex flex-col justify-between w-[60%] pl-[2%] my-[2%]">
                    <button onClick={props.buyBuilding} className="text-[#FFFDE7] max-w-[85%] text-lg hover:border-[#FFFDE7] mr-[2%] bg-[#680C07] border-[2px] border-[#A8A9AD] py-[1px] px-[5px] rounded-md self-center">Buy 1</button>
